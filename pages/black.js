    ...
    return (
        <div className="relative flex flex-col-reverse items-center justify-between w-full h-screen px-2 overflow-hidden text-3xl font-bold bg-black lg:px-12 md:flex-row font-popi ">
            ...
            <div className="flex flex-col  z-40 justify-center md:pb-20 overflow-hidden w-full md:flex-[.45] h-full  md:h-screen  ">
                <h1 className="w-[90%] md:w-[90%] text-xl md:text-4xl">
                    <Typewriter
                        ...
                        onInit={(typewriter) => {
                            typewriter
                                .typeString(
                                    `<h1 style="color:#FFF "> Get credits anytime, anywhere, with <span style="color:#5DF6AE">no collateral,</span>  and pay on your preferred <span style="color:#5DF6AE">schedule!</span> </h1>`
                                )
                                .start();
                            // .pauseFor(2500)
                            // .deleteAll()
                ...
                <h5 className="text-sm text-[#FFF] w-[75%] md:w-[50%] font-medium mt-2">
                    Knockdown inflation and purchase now, and enjoy every moment
                    of your payment without stress
                </h5>
                <div className="h-8 w-[210px]  rounded-xl flex flex-row items-center mt-8 justify-between relative border border-[1.6px] border-white  ">
                    <h6 className="text-[10px]  font-semibold uppercase flex-[.5] text-center text-[#FFF] ">
                        coming soon
                    </h6>
